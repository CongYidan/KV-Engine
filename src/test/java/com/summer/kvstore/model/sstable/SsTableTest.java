...
public class SsTableTest {
    ...
    @Test
    public void query() {
        SsTable ssTable = SsTable.createFromFile(KVConstants.WORK_DIR + "0_1.sst", true);
        System.out.println("key0: " + ssTable.query("key0"));
        System.out.println("key00000: " + ssTable.query("key00000"));
